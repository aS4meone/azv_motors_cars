        ...
        for v in vehicles:
            try:
                ...
                if fr_lock or fl_lock or rl_lock or rr_lock:
                    ...
                    print(f"[DEBUG] Haval F7x - looking for locks in UnregisteredSensors")
                    ...
                    print(f"[DEBUG] Found locks: fr={fr_lock_unreg}, fl={fl_lock_unreg}, rl={rl_lock_unreg}, rr={rr_lock_unreg}")
                    ...
                    print(f"[DEBUG] Final locks: fr={v.front_right_door_locked}, fl={v.front_left_door_locked}, rl={v.rear_left_door_locked}, rr={v.rear_right_door_locked}")
